# DRAFT - Angular Boot Camp Curriculum - ng-switch
...
[StackBlitz for ng-switch](https://stackblitz.io/github/AngularBootCamp/ng-switch)

Alternatively, you can clone the repository locally and run the
following commands:

```
git clone git@github.com:AngularBootCamp/ng-switch.git
cd ng-switch
yarn
yarn start
```
